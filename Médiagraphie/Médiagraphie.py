...
def v_process_bibliography():
	#start_time = time.time()
	global v_websites, v_working, video
...
def start_screen():
	...
	def settings():
		setting_themes = Button(master=page1, text=' Color Themes ', bg=btn_color, fg=font_color, bd=0, activebackground=btn_color_pressed, activeforeground=font_color, command=select_colors, compound=LEFT, font=big_font)
	...
	start_button = Button(master=page1, text='Press to start', command=get_language, bg=btn_color, fg=font_color, bd=0, activebackground=btn_color_pressed, activeforeground=font_color, font=big_font, width=15, height=2)
